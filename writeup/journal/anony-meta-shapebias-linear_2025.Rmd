...
and citations of two papers [@landau1988; @imai1997]. In addition to previously identified studies through domain knowledge and reference lists. Figure \ref{fig:prisma} shows a PRISMA diagram describing our screening process. We only included published papers, excluding unpublished theses and dissertations.

```{r prisma, eval= FALSE, include= FALSE, fig.height = 3, fig.width =4, echo=FALSE, fig.cap="PRISMA diagram showing the results of our literature screening process.", fig.align = "center", fig.pos = "H"}
...
```{r prisma2}
prisma2 <- PRISMAstatement::prisma(found = 154,
       found_other = 22,
       no_dupes = 176, 
       screened = 176 , 
       screen_exclusions = 52, 
       full_text = 124,
       full_text_exclusions = 31, 
       qualitative = 93,
       quantitative = 93)
prisma2
```

```{r prisma ,fig.height = 3.5, fig.width= 3, echo=FALSE, fig.cap="PRISMA diagram showing the results of our literature screening process.", fig.align = "center", fig.pos = "H"}
#out.width = "100%"
#dev='png'
#from https://cran.r-project.org/web/packages/PRISMAstatement/vignettes/PRISMA.html
prisma <- PRISMAstatement::prisma(found = 154,
       found_other = 22,
       no_dupes = 176, 
       screened = 176 , 
       screen_exclusions = 52, 
