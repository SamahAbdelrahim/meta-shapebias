...
author-information: > 
    ...
    \author{{\large \bf Samah Abdelrahim (samahabd@stanford.edu)} \\ Department of Psychology, Stanford University
...
2. There is a consistent association between population (with language as a proxy) and shape bias, such that the largest effect will be observed in Indo-European populations, and the lowest in populations with the least industrialized environments. East Asian countries will lie in the middle. 
