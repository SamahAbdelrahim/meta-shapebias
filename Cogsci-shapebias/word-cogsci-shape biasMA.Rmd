---
title: "Is shape bias real? Examining the robustness and generalizability of the shape bias"
...
```{r prisma, out.width="200px", fig.retina = 1, fig.cap="PRISMA diagram showing the results of our literature screening process."}
...
Synthesizing effect sizes across studies revealed an overall evidence of shape bias that is dominated by English speakers, but with no significant evidence for a cross-cultural differece, and a huge between-study heterogeneity. 
...
We believe this work highlights the need for more investigation of the shape bias and word learning by developing consistent measures that answers to the questions of reliability and validity, as well as using unified procedures to facilitate interpretations and theoretical comparisons.  
